        ...
        >
          <div className="vvc-glass-panel rounded-3xl p-8 md:p-12">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="text-center vvc-glass-panel rounded-2xl">
                  <div className="text-3xl font-bold text-theme-blue mb-2">360°</div>
                  <div className="text-sm text-white/80">Aanpak</div>
                </div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 16 }}
              ...
              >
                <div className="text-center vvc-glass-panel rounded-2xl">
                  ...
                  <div className="text-sm text-white/80">Niveaus</div>
                </div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 16 }}
              ...
              >
                <div className="text-center vvc-glass-panel rounded-2xl">
                  ...
                  <div className="text-sm text-white/80">Sectoren</div>
                </div>
              </motion.div>
            </div>
          </div>
